module.exports = {
  ...
  diagramClass: require('./diagram.class.json'),
  diagramRelation: require('./diagram.relation.json'),
  diagramGeneralization: require('./diagram.generalization.json'),
  diagramGeneralizationSet: require('./diagram.generalizationset.json'),
